...
define_country_holidays(
    ...
    CountryHolidays([
        ...
        Holiday('海の日',
                rrule(YEARLY,
                      dtstart=datetime(2021, 7, 22),
                      until=datetime(2021, 7, 22),
                      bymonth=7, bymonthday=22)),
        Holiday('海の日',
                rrule(YEARLY,
        ...
        Holiday('山の日',
                rrule(YEARLY,
                      dtstart=datetime(2021, 8, 8),
                      until=datetime(2021, 8, 8),
                      bymonth=8, bymonthday=8)),
        Holiday('山の日',
                rrule(YEARLY,
                      dtstart=datetime(2022, 1, 1),
                      bymonth=8, bymonthday=11)),
        ...
        Holiday('スポーツの日',
                rrule(YEARLY,
                      dtstart=datetime(2021, 7, 23),
                      until=datetime(2021, 7, 23),
                      bymonth=7, bymonthday=23)),
        Holiday('スポーツの日',
                rrule(YEARLY,
                      dtstart=datetime(2022, 1, 1),
        ...
        Holiday('天皇誕生日',
                rrule(YEARLY,
                      dtstart=datetime(2023, 2, 23),
                      bymonth=2, bymonthday=23)),
